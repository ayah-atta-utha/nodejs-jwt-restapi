...
describe("NewsService", () => {
  ...
  beforeAll(() => {
    ...
    newsRepository = newsService["newsRepository"] as jest.Mocked<Repository<News>>;
  });

  it("should create a new news article", async () => {
    const newsData = { title: "Breaking News", content: "News content" };
    const savedNews = { ...newsData, id: 1 };
  ...
  it("should retrieve a news article by ID", async () => {
    const news = { id: 1, title: "Specific News", content: "Specific content" };
